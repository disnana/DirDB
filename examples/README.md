...
| Python | [auto_reload.py](python/auto_reload.py) | Native reload and invalid-edit repair | `python examples/python/auto_reload.py` |
| Python | [async_batch.py](python/async_batch.py) | Native async batch reads and writes | `python examples/python/async_batch.py` |
...
| Rust | [batch](rust/basic/src/bin/batch.rs) | Ordered native batch operations | `cargo run --manifest-path examples/rust/basic/Cargo.toml --bin batch` |
